                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    ...
                                    <input
                                        ...
                                        disabled={!isEditing}
                                        className="pl-10 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm disabled:bg-gray-50 disabled:text-gray-500"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        disabled={!isEditing}
                                        className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm disabled:bg-gray-50 disabled:text-gray-500"
                                    />
                                </div>
