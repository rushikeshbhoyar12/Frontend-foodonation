...
export default function Navbar() {
        ...
        const fetchUnreadCount = async () => {
            if (user && token) {
                try {
                    ...
                    // Also fetch requests for donors
                    if (user.role === 'donor') {
                        const requestsData = await requestsAPI.getRequestsForMyDonations(token);
    ...
    // Get notifications to display (show all for now, don't filter)
